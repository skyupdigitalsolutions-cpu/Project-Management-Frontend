...
function MyReportTab() {
  ...
  return (
    <div className="space-y-5">
          ...
          <div className="bg-[#1a1f2e] border border-white/10 rounded-xl w-full max-w-xl max-h-[90vh] overflow-y-auto shadow-2xl">
            <div className="flex items-center justify-between p-5 border-b border-white/10">
              <div>
                ...
                <p className="text-xs text-slate-500 mt-0.5">{format(new Date(), 'MMMM d, yyyy')} · Visible to Admin</p>
              </div>
      ...
      {/* History */}
      <div className="card">
        <h3 className="text-sm font-semibold text-white mb-4">My Report History</h3>
        {history.length === 0 ? (
  ...
  return (
    <div className="space-y-5">
      ...
      <div className="flex items-center gap-2 flex-wrap">
        ...
        <span className="text-xs text-slate-600 ml-auto">{pagination.total} report{pagination.total !== 1 ? 's' : ''}</span>
      </div>
