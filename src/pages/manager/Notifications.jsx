        ...
        {loading ? (
          ...
          >
            ...
            <div className="flex items-center gap-1 flex-shrink-0">
              {tab === 'inbox' && (
                <button onClick={() => openReply(n)} className="text-neutral hover:text-primary p-1 rounded transition-colors" title="Reply">
                  <Reply size={14} />
                </button>
              )}
              <button onClick={() => deleteOne(n._id)} className="text-neutral hover:text-red-400 p-1 rounded transition-colors" title="Delete">
                <Trash2 size={14} />
              </button>
            </div>
          </div>
      ...
      >
        <div className="space-y-4">
          ...
          <FormField label="Recipients (leave empty = all users)">
            ...
            <div className="max-h-44 overflow-y-auto space-y-1 border border-gray-100 rounded-xl p-2 bg-gray-100">
              {users.map(u => (
        ...
        <div className="space-y-4">
          {replyTarget && (
            <div className="bg-gray-50 border border-gray-200 rounded-xl px-4 py-3">
              <p className="text-[16px] text-neutral mb-1">Original message</p>
              <p className="text-sm text-gray-600 italic">"{replyTarget.message}"</p>
            </div>
          )}
