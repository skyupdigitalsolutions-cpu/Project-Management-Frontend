...
export default function ProjectDetail() {
  ...
  const hasClient = ci.clientName || ci.companyName || ci.name || ci.company || ci.email
      ...
      {hasClient && (
        <div className="card">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
            {(ci.clientName || ci.name)    && <InfoItem icon={Users}    label="Client"  value={ci.clientName ?? ci.name} />}
            {(ci.companyName || ci.company) && <InfoItem icon={Building2} label="Company" value={ci.companyName ?? ci.company} />}
