...
import { Bell, Send, Trash2, RefreshCw, CheckCheck, Inbox, SendHorizonal } from 'lucide-react'
      ...
      <div className="space-y-2">
        {loading ? (
          ...
          >
            ...
            <button onClick={() => deleteOne(n._id)} className="text-neutral hover:text-red-400 p-1 rounded flex-shrink-0">
              <Trash2 size={14} />
            </button>
          </div>
        ))}
