...
import { Bell, Send, Trash2, RefreshCw, CheckCheck } from 'lucide-react'
...
export default function AdminNotifications() {
  ...
  const handleSend = async () => {
    ...
    setSending(true)
    try {
      // If no specific users selected, broadcast to ALL users
      ...
      <div className="space-y-2">
        {loading ? (
          ...
          >
            ...
            <button onClick={() => deleteOne(n._id)} className="text-slate-500 hover:text-red-400 p-1 rounded flex-shrink-0">
              <Trash2 size={14} />
            </button>
          </div>
        ))}
